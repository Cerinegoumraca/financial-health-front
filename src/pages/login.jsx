...
const Login = () => {
  ...
  return (
    ...
    <div className="pt-24 w-full h-screen bg-blue-200 flex justify-center items-center overflow-auto">
      <div className="flex flex-col md:flex-row rounded-lg overflow-hidden max-w-6xl w-full justify-center items-center">
        ...
        <div className="md:w-2/3 p-8 md:p-16 flex flex-col justify-center items-center">
          ...
          <div className="mb-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold lg:text-6xl xl:text-7xl poetsen-font text-gray-800">
              Welcome Back!
            </h2>
          </div>
          ...
          <div>
            ...
            <Link to="/signup" className="ml-2 text-gray-800 font-bold">
              Sign up
            </Link>
          </div>
