...
const Signup = () => {
  ...
  return (
    ...
    <div className="pt-20 w-full h-screen bg-blue-200 flex justify-center items-center overflow-auto">
  ...
  <div className="w-full lg:w-2/3 pt-20 p-8 md:p-16 flex flex-col justify-center items-center">
          ...
          <h3 className=" text-4xl md:text-5xl lg:text-6xl font-bold xl:text-7xl poetsen-font text-gray-800">
                Get Started
          </h3>
          ...
          <div>
            ...
            <Link to="/login" className="ml-2 text-gray-800 font-bold">
              Log In
            </Link>
          </div>
...
<div className="flex justify-between w-full mt-4 gap-2"> {/* Adjusted gap */}
  <button
    ...
    className="flex items-center justify-center p-3 w-[140px] md:w-[160px] h-[40px] bg-[#283593] text-white font-semibold rounded-md shadow-md hover:bg-[#3f51b5] focus:outline-none focus:ring-2 focus:ring-[#3f51b5] focus:ring-offset-2"
  >
